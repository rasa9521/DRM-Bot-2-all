...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7307554784:AAHIazTw-3-uv14Tll5StLA9Kd5UXchCzmc")
    API_ID = int(os.environ.get("API_ID",  "27120862"))
    API_HASH = os.environ.get("API_HASH", "53d8ec88810f7445732ea234121e6219")
